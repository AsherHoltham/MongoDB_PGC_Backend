...
export function RegisterForm ( { username, setUsernameAction, email, setEmailAction, password, setPasswordAction, setMessagesAction, onSubmitAction }: RegisterFormProps ) 
{
    let messages: string[] = [];
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        console.log("child sees:", username, email, password);
        onSubmitAction(e);
    }
